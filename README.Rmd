...
# TODO: ADD ISSUE: wrapped models formula environment is not global environment, probs should change this
...
unwrapped_model <- cv.glmnet(X, y)

# question: why do the following disagree? intercept related?
# TODO: INTERCEPT IN FORMULA_HELPER AND PREDICT.WRAPPED

predict(wrapped_model, head(mtcars))
predict(unwrapped_model, head(model.matrix(form, mtcars)))
```
